		...
		KeyValues: []*document.KeyValue{
			{
				...
				Value: &document.Array{
					Elements: []document.Value{
						&document.String{Value: "zero"},
						&document.String{Value: "one"},
						&document.String{Value: "two"},
					},
				},
			},
		},
			...
			},
			{
				...
				Elements: []*document.KeyValue{
					...
					},
					{
						...
						Value: &document.Array{
							Elements: []document.Value{
								&document.Integer{V: "8000"},
								&document.Integer{V: "8001"},
								&document.Integer{V: "8002"},
							},
						},
					},
					{
						...
						Value: &document.Array{
							Elements: []document.Value{
								&document.Array{
									Elements: []document.Value{
										&document.String{Value: "delta"},
										&document.String{Value: "phi"},
									},
								},
								&document.Array{
									Elements: []document.Value{
